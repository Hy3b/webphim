...
class AuthServiceTest {
        ...
        void register_passwordIsEncoded() {
                ...
                verify(userRepository).save(argThat(user -> "$2a$10$encodedHash".equals(user.getPasswordHash())));
        }
        ...
        void register_defaultRoleIsCustomer() {
                ...
                // Assert
                verify(userRepository).save(argThat(user -> User.Role.customer == user.getRole()));
        }
