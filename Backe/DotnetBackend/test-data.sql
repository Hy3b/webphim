...
('CINEMA-PAID-001', 3, 100000.00, 0.00, 100000.00, 'paid', 'SEPAY',
  DATE_ADD(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 2 HOUR), NOW()),
...
('CINEMA-PEND-002', 4, 200000.00, 0.00, 200000.00, 'pending', 'SEPAY',
  DATE_ADD(NOW(), INTERVAL 9 MINUTE), NOW(), NOW()),
...
('CINEMA-EXPD-003', 3, 160000.00, 0.00, 160000.00, 'expired', 'SEPAY',
  DATE_SUB(NOW(), INTERVAL 5 MINUTE), DATE_SUB(NOW(), INTERVAL 15 MINUTE), NOW()),
...
('CINEMA-CNCL-004', 4, 125000.00, 0.00, 125000.00, 'cancelled', 'SEPAY',
  DATE_SUB(NOW(), INTERVAL 30 MINUTE), DATE_SUB(NOW(), INTERVAL 1 HOUR), NOW());
