...
_(Ghi chú: Những mục ghi chú "của src gốc" bạn có thể giữ nguyên không cần đổi trừ khi kiến trúc mạng máy bạn khác biệt. Những mục `<Điền...>` thì bắt buộc bạn phải cập nhật thông tin của bạn vào)._
...
2. Gõ lệnh:
   ...
   ```
   _(Hoặc chạy qua file chạy Main trong IDE IntelliJ/Eclipse)_
...
_(Bạn cũng có thể làm điều tương tự siêu nhanh gọn với Ngrok: `ngrok http 8080`)._
